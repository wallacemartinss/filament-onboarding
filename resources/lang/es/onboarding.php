...
return [
    ...
    'resource' => [
        ...
        'tour' => [
            ...
            'add'             => 'Añadir parada',
            'target'          => 'Qué destacar',
            'target_helper'   => 'Leído del propio panel — los campos del formulario de esta página, sus botones, su tabla. Algunos formularios no se pueden leer desde fuera (los que dependen del registro que se edita, o de quién está mirando): sus campos no aparecerán en la lista, y el selector CSS es el camino.',
            'targets'         => [
                'on_this_page' => 'En esta página',
                'widgets'      => 'Widgets',
                'advanced'     => 'Avanzado',
                'custom'       => 'Un selector CSS propio…',
                'table'        => 'La tabla',
                'search'       => 'El campo de búsqueda',
                'submit'       => 'El botón de guardar',
                'column'       => 'Columna: :label',
                'new_record'   => 'El botón "Nuevo :label"',
            ],
        ...
        'targets' => [
            'resources'      => 'Recursos',
            'pages'          => 'Páginas',
            'tenant_profile' => 'Perfil del tenant',
            'page_names'     => [
                'index'  => 'listado',
                'create' => 'crear',
            ],
